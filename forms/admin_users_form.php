        ...
        <div class="col-md-4">
            <div class="radio">
                <label>
                    ...
                    <input type="radio" name="admin_type" value="Administrator" required="" <?php echo ($edit && $admin_account['admin_type'] =='super') ? "checked": "" ; ?>/> Administrator
                </label>
            </div>
            <div class="radio">
                <label>
                    <input type="radio" name="admin_type" value="Staff" required="" <?php echo ($edit && $admin_account['admin_type'] =='admin') ? "checked": "" ; ?>/> Staff
                </label>
            </div>
        </div>
    </div>
