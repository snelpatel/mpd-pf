...
$db = getDbInstance();
$select = array('id', 'f_name', 'm_name', 'l_name', 'city', 'phone', 'amount', 'intrest', 'balance', 'parentsname', 'parentsphone', 'created_at','updated_at');
...
<div id="page-wrapper">
    <div class="row">
        ...
        <div class="col-lg-6">
            <h1 class="page-header">Student Loans</h1>
        </div>
        ...
        <tbody>
            <?php foreach ($customers as $row) : ?>
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($row['parentsname']) ?> </td>
                    <td><?php echo htmlspecialchars($row['parentsphone']) ?> </td>
	                <td>
					<a href="edit_student.php?customer_id=<?php echo $row['id'] ?>&operation=edit" class="btn btn-primary" style="margin-right: 8px;"><span class="glyphicon glyphicon-edit"></span>

					<a href="delete_customer.php?del_id=<?php echo $row['id'] ?>"  class="btn btn-danger delete_btn" style="margin-right: 8px;"><span class="glyphicon glyphicon-trash"></span></td>
				</tr>

						<!-- Delete Confirmation Modal-->
					 <div id="confirm-delete-<?php echo $row['id'] ?>">
					      <form action="delete_customer.php?del_id=<?php echo $row['id'] ?>" method="POST">
