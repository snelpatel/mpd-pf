...
if ($_SERVER['REQUEST_METHOD'] == 'POST') 
{
    ...
    $tempFileName41 = $_FILES["resumes1"]["tmp_name1"];    
    $result41 = move_uploaded_file($tempFileName41,$fileTarget41);      
    if(!$result41)
    { 
      $error = "Could not save CV or Resume file as $filename41!";     
      exit(); 
    }

    $name42= $_FILES['resumes2']['name'];
    ...
    $tempFileName42 = $_FILES["resumes2"]["tmp_name2"];    
    $result42 = move_uploaded_file($tempFileName42,$fileTarget42);      
    if(!$result42)
    { 
      $error = "Could not save CV or Resume file as $filename42!";     
      exit(); 
    }


    $name43= $_FILES['resumes3']['name'];
    ...
    $tempFileName43 = $_FILES["resumes3"]["tmp_name3"];    
    $result43 = move_uploaded_file($tempFileName43,$fileTarget43);      
    if(!$result43)
    { 
      $error = "Could not save CV or Resume file as $filename43!";     
      exit(); 
    }

    $name44= $_FILES['resumes4']['name'];
    ...
    $tempFileName44 = $_FILES["resumes4"]["tmp_name4"];    
    $result44 = move_uploaded_file($tempFileName44,$fileTarget44);      
    if(!$result44)
    { 
      $error = "Could not save CV or Resume file as $filename44!";     
      exit(); 
    }
...
<div class="row">
    ...
    <tr>
        ...
        <td width="20%" style="padding-right: 10px"><video id="video" width="160" height="120" autoplay></video></td>
        <td width="20%" style="padding-right: 10px"><input type="button" id="snap" value="Take Photo >>" /></td>
        <td width="20%" style="padding-right: 10px"><canvas id="canvas" width="160" height="120"></canvas></td>
...
<hr>    
    ...
    <div class="form-group">
        <table>
    <tr>
        <td><label for="resumes">Other Files </label>
        <input type="file" name="resumes" value="<?php echo $edit ? $customer['resumes'] : ''; ?>" class="form-control" id="resumes"><input type="file" name="other1" value="<?php echo $edit ? $customer['other1'] : ''; ?>" class="form-control" id="other1"><input type="file" name="other2" value="<?php echo $edit ? $customer['other2'] : ''; ?>" class="form-control" id="other2"><input type="file" name="other3" value="<?php echo $edit ? $customer['other3'] : ''; ?>" class="form-control" id="other3"><input type="file" name="other4" value="<?php echo $edit ? $customer['other4'] : ''; ?>" class="form-control" id="other4"></td>      
        </tr>
    </table>
    </div> 
<br/>
